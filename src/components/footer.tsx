    ...
    useEffect(() => {
        fetch("/api/public/settings")
            ...
            .then((data) => {
                ...
                if (data.office_data) {
                    try {
                        const parsed: OfficeData[] = JSON.parse(data.office_data);
                        if (parsed.length > 0) {
                            setOfficeAddresses(parsed.map((o) => o.address));
                        }
                    } catch { /* use defaults */ }
                }
            })
        ...
        <footer className="bg-gray-900">
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12">
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-[10px] text-gray-500">
                                    Telkomsel Authorized Partner
                                </p>
                            </div>
                        </div>
                        <p className="text-sm text-gray-400 leading-relaxed">
                            PT Agrabudi Komunika adalah mitra resmi Telkomsel yang beroperasi
                            di wilayah Kab. Cirebon, Kota Cirebon, dan Kab. Kuningan. Kami
                            berkomitmen menghadirkan layanan telekomunikasi terbaik untuk
                            pelanggan.
                        </p>
                        <div className="flex gap-3">
                            {socialLinks.map((social) => (
                                <a
                                    ...
                                    className="w-10 h-10 rounded-xl bg-gray-800 flex items-center justify-center text-gray-400 hover:bg-red-600 hover:text-white transition-all duration-300"
                                >
                                    {social.icon}
                                </a>
                            ))}
                ...
                <div className="text-center text-sm text-gray-500">
                    <p>
                        &copy; {new Date().getFullYear()} PT Agrabudi Komunika. All rights
                        reserved.
                    </p>
                </div>
            </div>
